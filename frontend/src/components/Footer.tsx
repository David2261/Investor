...
const DOT = <div className="rounded-full h-0.5 w-0.5 bg-slate-400"></div>;
...
const Messangers = (
	<div className="mx-4 flex flex-col">
		<div className="flex flex-row py-10 gap-4 border-b-2">
			...
			{ DOT }
			<div className="px-6 hover:text-red-600">
...
const GlobalLinks = (
	<div className="mx-4 flex flex-col">
		<div className="flex flex-row py-10 gap-4 border-b-2">
			<div className="px-4 hover:text-red-600">
...
const LocalLinks = (
	<div className="mx-4 flex flex-col">
		<div className="flex flex-row py-10 gap-4 border-b-2">
			<div className="px-4 hover:text-slate-900">
			...
			{ DOT }
			<div className="px-4">Privacy & Cookies</div>
			{ DOT }
			<div className="px-4">Your Privacy Choices</div>
		</div>
	</div>
);
...
const Footer = (props: Props) => {
	...
	return <>
		<div className="w-full bg-blue-100 flex flex-col">
			<div className="text-slate-800 flex flex-row mx-32 justify-center">
				{Messangers}
			</div>
			<div className="text-slate-800 flex flex-row mx-32 justify-center">
				{GlobalLinks}
			</div>
			<div className="text-slate-500 flex flex-row mx-32 justify-center">
				{LocalLinks}
			</div>
			<div className="flex flex-row my-10 justify-center">&copy; 2023 Investor Home. All rights reserved.</div>
		</div>
	</>
};
