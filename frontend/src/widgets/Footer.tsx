...
const Messangers = (
	<div className="md:mx-4 flex flex-col">
		<div className="flex flex-row py-4 md:py-10 gap-2 md:gap-4 border-b-2">
			...
			{ DOT }
			<div className="px-2 md:px-6">
				<NavLink to="https://www.linkedin.com/in/bulat-nasyrov-7705231bb/" target='_blank' rel="noopener noreferrer">
			...
			{ DOT }
			<div className="px-2 md:px-6">
				<NavLink to="https://twitter.com/ad_ge_1" target='_blank' rel="noopener noreferrer">
			...
			{ DOT }
			<div className="px-2 md:px-6">
				<NavLink to="https://github.com/David2261" target='_blank' rel="noopener noreferrer">
			...
			<div className="px-2 md:px-6 hover:text-red-600">
				<NavLink to="https://www.pinterest.ch/bulatnasirov2003/" target='_blank' rel="noopener noreferrer">
